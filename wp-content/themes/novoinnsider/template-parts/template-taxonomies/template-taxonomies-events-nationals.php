                    ...
                    <?php while($listPostAcademy->have_posts()) : $listPostAcademy->the_post() ?>
                        ...
                        <?php if(isset($listContentModules) && !empty($listContentModules)) : ?>
                            ...
                            <?php foreach($listContentModules as $listContentModule) : ?>
                                ...
                                <div class="col-12 col-md-4 col-lg-3 col-xl-3 col-xxl-3 col-xxxl-3 d-flex flex-column justify-content-center align-items-center container-card-category m-0 p-0 mt-3 mb-3">
                                    <div class="col-11 d-flex justify-content-center align-items-center">
                                        <a href="<?php echo get_permalink($postActivityId); ?>" style="text-decoration: none;">
                                            <div class="card" style="border: none !important">
                                                <?php if($imageModuleAcademy) : ?>
                                                    <img src="<?php echo wp_get_attachment_url($imageModuleAcademy); ?>" alt="Podcast">
                                                <?php endif; ?>
                                                <div class="card-info mt-1">
                                                    ...
                                                    <?php if($titleModuleAcademy) : ?>
                                                        <h2 class="NotoSans-Bold title-color"><?= $titleModuleAcademy; ?></h2>
                                                    <?php endif; ?>
                                                    <?php if($speakerModuleAcademy) : ?>
                                                        <p class="NotoSans-SemiBold description-color"><?= $speakerModuleAcademy; ?></p>
                                                    <?php endif; ?>     
                                                </div>
                                            </div>
                                        </a>
